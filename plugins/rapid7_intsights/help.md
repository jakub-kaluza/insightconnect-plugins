...
This action is used to get a list of all CVE's from an account.
...
This action is used to add CVE's to account.
...
|success_amount|integer|True|Amount of successfully added CVE's|
...
This action is used to delete CVE's from account.
...
|----|----|--------|-----------|
|failure|[]cve_failure_type|True|Failure details|
|success_amount|integer|True|Amount of successfully deleted CVE's|
...
* 3.1.0 - Add new actions Add CVE and Delete CVE
